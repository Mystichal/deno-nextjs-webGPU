...
.PHONY: build-spacetimedb
build-spacetimedb: ## Build the spacetimedb docker image.
	docker compose -f .docker/spacetimedb/compose.yaml build

.PHONY: start-spacetimedb
start-spacetimedb: ## Start the spacetimedb docker container.
	docker compose -f .docker/spacetimedb/compose.yaml up -d

.PHONY: stop-spacetimedb
stop-spacetimedb: ## Stop the spacetimedb docker container.
	docker compose -f .docker/spacetimedb/compose.yaml down